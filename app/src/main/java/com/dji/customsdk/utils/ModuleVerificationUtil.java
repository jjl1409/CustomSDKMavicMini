package com.dji.customsdk.utils;
...
public class ModuleVerificationUtil {
    public static boolean isProductModuleAvailable() {
        return (null != NewApplication.getProductInstance());
    }

    public static boolean isAircraft() {
        return NewApplication.getProductInstance() instanceof Aircraft;
    }

    public static boolean isHandHeld() {
        return NewApplication.getProductInstance() instanceof HandHeld;
    }

    public static boolean isCameraModuleAvailable() {
        return isProductModuleAvailable() && (null != NewApplication.getProductInstance().getCamera());
    }

    public static boolean isPlaybackAvailable() {
        return isCameraModuleAvailable() && (null != NewApplication.getProductInstance()
                .getCamera()
                .getPlaybackManager());
    }
    ...
    public static boolean isRemoteControllerAvailable() {
        return isProductModuleAvailable() && isAircraft() && (null != NewApplication.getAircraftInstance()
                .getRemoteController());
    }
    ...
    public static boolean isCompassAvailable() {
        return isFlightControllerAvailable() && isAircraft() && (null != NewApplication.getAircraftInstance()
                .getFlightController()
                .getCompass());
    }
    ...
    public static boolean isGimbalModuleAvailable() {
        return isProductModuleAvailable() && (null != NewApplication.getProductInstance().getGimbal());
    }

    public static boolean isAirlinkAvailable() {
        return isProductModuleAvailable() && (null != NewApplication.getProductInstance().getAirLink());
    }

    public static boolean isWiFiLinkAvailable() {
        return isAirlinkAvailable() && (null != NewApplication.getProductInstance().getAirLink().getWiFiLink());
    }

    public static boolean isLightbridgeLinkAvailable() {
        return isAirlinkAvailable() && (null != NewApplication.getProductInstance()
                .getAirLink()
                .getLightbridgeLink());
    }
    ...
    public static AccessoryAggregation getAccessoryAggregation() {
        Aircraft aircraft = (Aircraft) NewApplication.getProductInstance();
    ...
    public static boolean isMavic2Product() {
        BaseProduct baseProduct = NewApplication.getProductInstance();
        if (baseProduct != null) {
